...
curl --fail --silent --show-error --retry 5 "$repo_raw/automation/validate_dashboard_structure.py" -o /tmp/validate_dashboard_structure.py
...
sudo install -o ubuntu -g ubuntu -m 0755 /tmp/validate_dashboard_structure.py "$app/validate_dashboard_structure.py"
...
sudo python3 "$app/validate_dashboard_structure.py" "$site/index.html"
