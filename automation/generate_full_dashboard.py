...
required += ['id="xhs-ad-chart-tooltip"','id="xhs-ad-chart-guide"','id="xhs-ad-week-head"','id="xhs-ad-week-table"','function xhsAdWeekPeriods(','function renderXhsAdWeeklyTable(','function bindXhsAdChartHover(']
