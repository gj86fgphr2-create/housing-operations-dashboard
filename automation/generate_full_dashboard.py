...
required += ['data-dashboard-view="contract-details"','id="contract-details"','id="contract-detail-new-table"','id="contract-detail-renewal-table"','id="contract-detail-checkout-table"','function renderMonthlyContractDetails()','"monthlyDetails"','"signSource"']
