...
required=['data-dashboard-view="operations-brief"','data-dashboard-view="overview"','data-dashboard-view="performance"','data-dashboard-view="occupancy"','data-mobile-module="xiaohongshu"','data-mobile-module="yuxiaor"','5%以下绿色','brief-daily-table','brief-project-table','brief-person-table','xhs-account-table','邮箱密码不匹配']
