...
required += ['<a href="#xhs-leads" data-dashboard-view="xhs-leads">目标管理</a>','<h3>笔记数量与目标</h3>']
...
if rendered.count('<a href="#xhs-leads" data-dashboard-view="xhs-leads">目标管理</a>') != 2: raise RuntimeError("XHS target-management menu must exist on desktop and mobile")
