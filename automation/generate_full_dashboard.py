...
if any(marker in rendered for marker in ('id="customer-daily-table"','id="customer-funnel-table"','id="customer-kpi-published"')): raise RuntimeError("Legacy customer seven-day panels must stay hidden")
if 'class="table-wrap customer-wechat-table-wrap"' in rendered: raise RuntimeError("Legacy vertical customer trend table must stay removed")
