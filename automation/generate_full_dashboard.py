...
required += ['id="xhs-ad-chart-tooltip"','id="xhs-ad-chart-guide"','id="xhs-ad-week-month-filter"','id="xhs-ad-week-team-filter"','id="xhs-ad-week-account-filter"','id="xhs-ad-week-summary"','id="xhs-ad-week-head"','id="xhs-ad-week-table"','function xhsAdPrepareWeekControls(','function xhsAdWeekPeriods(','function renderXhsAdWeeklyTable(','function bindXhsAdChartHover(']
